...
public class ViewAdminBoard extends JFrame{
	...
	private void initialize() {
		...
		panel.add(lblNewLabel_5);
		 // client registers here if passwords matches with each other
			...
			public void actionPerformed(ActionEvent e) {
				if(passwordField.getText().equals(passwordField_control.getText())) {
					...
					if(!(Main.ifRegistered(textField_mail.getText(), passwordField.getText()))) {
						Main.registerAdmin(textField_name.getText(),textField_mail.getText(),passwordField.getText(),Integer.parseInt(textfield_age.getText()),(25<Integer.parseInt(textfield_age.getText())),true);
